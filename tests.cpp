...
int main(int argc, char** argv){
    ...
    int kmp_max = 10;
    for(string s : all_binary_substrings_up_to(kmp_max)){
        for(string p : all_binary_substrings_up_to(s.size())){
    ...
    for(string s : all_binary_substrings_up_to(rabin_karp_max)){
        for(string p : all_binary_substrings_up_to(s.size())){
